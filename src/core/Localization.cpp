...
constexpr std::array kTranslations{
    Translation{"Open Model...", "モデルを開く...", "모델 열기..."},
    Translation{"Open Model", "モデルを開く", "모델 열기"},
    Translation{"Open model", "モデルを開く", "모델 열기"},
    Translation{"Model: %s", "モデル: %s", "모델: %s"},
    Translation{"Add Reference Model...", "参照モデルを追加...", "참고 모델 추가..."},
    Translation{"Add reference model", "参照モデルを追加", "참고 모델 추가"},
    Translation{"Open reference model", "参照モデルを開く", "참고 모델 열기"},
    Translation{"Model and Base Color loading is available only in Main Viewport.", "モデルとベースカラーはメインビューポートで読み込めます。", "모델과 베이스 컬러는 메인 뷰포트에서 불러올 수 있습니다."},
    Translation{"Loading model...", "モデルを読み込み中...", "모델 불러오는 중..."},
    Translation{"Finishing canceled import...", "キャンセル処理中...", "불러오기 취소 처리 중..."},
    Translation{"Cancel import", "読み込みをキャンセル", "불러오기 취소"},
    Translation{"Model import canceled.", "モデルの読み込みをキャンセルしました。", "모델 불러오기를 취소했습니다."},
    Translation{"Finish or cancel the current model import first.", "現在の読み込みを完了またはキャンセルしてください。", "진행 중인 모델 불러오기를 완료하거나 취소하세요."},
    Translation{"Reference model loaded.", "参照モデルを読み込みました。", "참고 모델을 불러왔습니다."},
    Translation{"Model and Base Color loaded.", "モデルとベースカラーを読み込みました。", "모델과 베이스 컬러를 불러왔습니다."},
    Translation{"Editing material", "編集するマテリアル", "편집할 재질"},
    Translation{"Choose editing material", "編集するマテリアルを選択", "편집할 재질 선택"},
    Translation{"This texture is shared by multiple materials.", "このテクスチャは複数のマテリアルで共有されています。", "이 텍스처는 여러 재질이 공유합니다."},
    Translation{"Import warnings: %zu", "読み込みの警告: %zu", "불러오기 경고: %zu개"},
    Translation{"Base Color: %u x %u", "ベースカラー: %u x %u", "베이스 컬러: %u x %u"},
    Translation{"Use material", "このマテリアルを使用", "이 재질 사용"},
    Translation{"Choose a Base Color PNG to replace the missing image.", "見つからない画像の代わりにベースカラーPNGを選択してください。", "누락된 이미지를 대신할 베이스 컬러 PNG를 선택하세요."},
    Translation{"Choose Base Color PNG", "ベースカラーPNGを選択", "베이스 컬러 PNG 선택"},
    Translation{"Cancel", "キャンセル", "취소"},
    Translation{"Imported Base Color", "読み込んだベースカラー", "가져온 베이스 컬러"},
    Translation{"UV overlap analysis is incomplete for this model.", "このモデルのUV重複解析は一部のみです。", "이 모델의 UV 겹침 검사가 일부만 완료되었습니다."},
    Translation{"Last model and texture loaded.", "前回のモデルとテクスチャを読み込みました。", "마지막 모델과 텍스처를 불러왔습니다."},
    Translation{"The last model or texture file is no longer available.", "前回のモデルまたはテクスチャが見つかりません。", "마지막 모델 또는 텍스처 파일을 찾을 수 없습니다."},
    Translation{"Texture PNG saved. The source model is unchanged.", "テクスチャPNGを保存しました。元モデルは変更されません。", "텍스처 PNG를 저장했습니다. 원본 모델은 변경하지 않았습니다."},
    Translation{"Choose a .png filename for the edited texture.", "編集したテクスチャには.pngファイル名を指定してください。", "편집한 텍스처는 .png 파일 이름으로 저장하세요."},
    Translation{"This material has no UV coordinates. Supply UVs in the source model.", "このマテリアルにはUVがありません。元モデルにUVを追加してください。", "이 재질에는 UV가 없습니다. 원본 모델에 UV를 추가하세요."},
    Translation{"Translucent materials are display-only; use an opaque or alpha-mask material for editing.", "半透明マテリアルは表示専用です。編集には不透明またはアルファマスクを使用してください。", "반투명 재질은 표시 전용입니다. 불투명 또는 알파 마스크 재질을 편집 대상으로 사용하세요."},
    Translation{"A zero Base Color factor prevents texture projection. Adjust the source material.", "ベースカラー係数が0のため投影できません。元マテリアルを調整してください。", "베이스 컬러 계수가 0이어서 투영할 수 없습니다. 원본 재질을 조정하세요."},
    Translation{"Editing requires a single 0..1 UV atlas. Tiled and UDIM UVs are display-only.", "編集には0～1のUVアトラスが必要です。タイルとUDIMは表示専用です。", "편집에는 0~1 범위의 단일 UV 아틀라스가 필요합니다. 반복 및 UDIM UV는 표시 전용입니다."},
    ...
    Translation{"Wait for temporary file cleanup before creating a projection.", "一時ファイルの削除が完了してからプロジェクションを作成してください。", "임시 파일 정리가 끝나면 새 프로젝션을 만들 수 있습니다."},
