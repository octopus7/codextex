...
constexpr std::array kTranslations{
    ...
    Translation{"Suggest mask with Codex", "Codexでマスクを提案", "Codex로 마스크 제안"},
    ...
    Translation{"Codex mask proposal applied; refine it before baking.", "Codexのマスク提案を適用しました。ベイク前に調整してください。", "Codex 마스크 제안을 적용했습니다. 베이크 전에 다듬으세요."},
